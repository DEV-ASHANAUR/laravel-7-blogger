        ...
        <div class="row row-sm">
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                    <form class="register-form outer-top-xs" method="POST" action="{{ route('admin.profile.update') }}" id="Myform_profile" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" value="{{ Auth::guard('admin')->user()->name }}" class="form-control unicase-form-control text-input" id="name" placeholder="Enter Fullname" required />
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="email" name="email" value="{{ Auth::guard('admin')->user()->email }}" class="form-control unicase-form-control text-input" id="exampleInputEmail2" placeholder="Enter Email" />
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="number" name="phone" value="{{ Auth::guard('admin')->user()->phone }}" class="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="Enter Phone" />
