            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.post.update',$post->id) }}" method="POST" autocomplete="off" id="Myform_post" enctype="multipart/form-data">
                            @csrf 
                            @method('put')
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <label for="name">Title</label>
                                    <input type="text" class="form-control" id="name" name="title" value="{{ $post->title }}" placeholder="Enter Post title">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="tag" name="tags" data-role="tagsinput" value=" @foreach($post->tags as $tags){{$tags->name.','}} @endforeach" placeholder="Tag (separated by ,)"  required />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <div class="form-check mt-2">
                                        <div class="checkbox">
                                            <label for="checkbox1" class="form-check-label ">
                                                <input type="checkbox" id="checkbox1" name="status" value="1" {{$post->status == 1 ? 'checked':""}} class="form-check-input">Published
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Update Post</button>
                        </form>
                    </div>
                </div>
            </div>
